...
A generic n8n node to operate with any SinergiaCRM (7.x+) module via the official JSON API.
...
n8n caches loaded node classes. When upgrading from v2.2.5 or earlier, clear the cache and reinstall:
